...
namespace Microsoft.AspNet.WebHooks
{
    ...
    public static class IServiceProviderExtensions
    {
        ...
        // public static SettingsDictionary GetSettings(this IServiceCollection services)
        // {
        //     SettingsDictionary settings = services.OfType<SettingsDictionary>().FirstOrDefault();
